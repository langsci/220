...
For instance, according to \citet[111]{Bybee2010}, the correlation between the order of verb and \isi{object} and that of verb and \isi{auxiliary} does not need a particular functional explanation, as auxiliaries are usually derived from the main verb of a complement construction\is{complement clause} that includes an \isi{infinitive}, or some other type of verb, as verbal \isi{complement} (e.g. `want' \textsc{infinitive}). If the verb precedes the verbal \isi{complement} of a complex VP in the diachronic source, the \isi{auxiliary} precedes the main verb in the target construction; but if the verb follows the verbal \isi{complement} in the diachronic source, the \isi{auxiliary} is postposed to the main verb in the target construction. As a consequence of these developments, the order of \isi{auxiliary} and verb correlates with that of verb and \isi{object} \REF{ex:diessel:18}.
