...
\shorttitlerunninghead{Weak universal forces: The discriminatory\is{ambiguity} function of case in DOM\is{differential object marking} systems}
...
\langinfo{\ili{Donno Sɔ}}{Dogon: Mali}{\citealt{Culy1995}: 48}\\
...
\langinfo{\ili{Donno Sɔ}}{Dogon: Mali}{\citealt{Culy1995}: 53}\\
...
\langinfo{{\ili{Malayalam}}}{\ili{Dravidian}: India}{\citealt{AsherKumari1997}: 204}\\
...
\langinfo{{\ili{Catalan}}}{\ili{Romance}: Spain}{\citealt{WheelerEtAl1999}: 243}\\
...
\langinfo{{\ili{Spanish}}}{\ili{Romance}: Spain}{\citealt{vonHeusingerKaiser2007}: 89}\\
...
\langinfo{{\ili{Hup}}}{Nadahup: Brazil/Columbia}{\citealt{Epps2009_DOM}: 95}\\
...
Similarly, the Papuan language \ili{Awtuw} obligatorily marks all pronominal\is{pronoun} and proper-name direct \isi{object}s regardless of whether there is a need for discrimination\is{ambiguity} or not:

\ea\label{ex:serzant:18}
\langinfo{{\ili{Awtuw}}}{Sepik: Papua New Guinea}{\citealt{Feldman1986}: 109}\\
...
\langinfo{{Chinese\il{Chinese (Mandarin)}}}{Sinitic: China}{\citealt{LiThompson1981}: 464}\\
...
\langinfo{Chinese\il{Chinese (Mandarin)}}{Sinitic: China}{\citealt{Bisang1992}: 158}\\
\ea
...
\ea 
\langinfo{\ili{Mam}}{\ili{Mayan}: Guatemala}{\citealt{England1983}: 213}\\
...
\ea 
\langinfo{\ili{Mam}}{\ili{Mayan}: Guatemala}{\citealt{England1983}: 212—213}\\
\ea
...
\ea 
\langinfo{\ili{Tamasheq} }{\ili{Afro-Asiatic}, Berber: North Africa; \citealt{Heath2007}: 91}{glosses adapted}\\
...
At least two \ili{Loloish} languages (\ili{Tibeto-Burman}) also attest a strong discriminatory\is{ambiguity} function that is not subordinate to some other force. The direct-\isi{object} markers \textit{tʰ}\textit{aʔ} in \ili{Lahu} and \textit{tʰ}\textit{ie} in \ili{Lolo} are only used if the context does not help to discriminate between A and P. That is, these markers code direct \isi{object}s only where the inherent semantics of the participants (such as \isi{animacy}) and the semantics of the event fail to do so:

\ea\label{ex:serzant:25}
\langinfo{Yongren Lolo\il{Lolo (Yongren)} }{{\ili{Tibeto-Burman}, \ili{Loloish}: China}{}adapted from \citealt{Gerner2008}: 299}\footnote{I simplified the transliteration and slightly adjusted the glossing of all examples from \citet{Gerner2008}.}\\
...
\langinfo{Yongren Lolo\il{Lolo (Yongren)} }{{\ili{Tibeto-Burman}}, \ili{Loloish}: China}{adapted from \citealt{Gerner2008}: 300}\\
...
\langinfo{Yongren Lolo\il{Lolo (Yongren)} }{{\ili{Tibeto-Burman}}, {\ili{Loloish}}: China}{adapted from \citealt{Gerner2008}: 299}\\
...
\ea 
\langinfo{\ili{Khwe}}{Khoe: Southern Africa}{adapted from \citealt{KilianHatz2006}: 83}\\
\ea
\gll  Tcá   tí   à   kx’ṓā´.\\
