...
In support of the hypotheses in \REF{ex:ksb:2}, Hawkins cites some of \citegen{Dryer2005_Def}'s \textit{WALS} data, which show, indeed, that free-standing definite articles are relatively more frequent in VO-languages (more on the data below).
