...
\lspbottomrule
\end{tabularx}
\caption{Distribution of articles in different word-order types (\citealt{Dryer2013a}; \citealt{Dryer2013b})}
\label{tab:ksb:1}
\end{table} 
