...
main.snd: main.bbl
	...
	sed -i 's/{Collins|/{Collins, Jeremy@Collins, Jeremy|/' main.adx
	sed -i 's/{Comrie|/{Comrie, Bernard@Comrie, Bernard|/' main.adx
	sed -i 's/{Croft|/{Croft, William@Croft, William|/' main.adx
	sed -i 's/{Dryer|/{Dryer, Matthew S.@Dryer, Matthew S.|/' main.adx
	sed -i 's/{Diessel|/{Diessel, Holger@Diessel, Holger|/' main.adx
	sed -i 's/{Schmidtke-Bode|/{Schmidtke-Bode, Karsten@Schmidtke-Bode, Karsten|/' main.adx
	sed -i 's/{Levshina|/{Levshina, Natalia@Levshina, Natalia|/' main.adx
	sed -i 's/{Seržant|/{Seržant, Ilja A.@Seržant, Ilja A.|/' main.adx
	sed -i 's/{Kiparsky|/{Kiparsky, Paul@Kiparsky, Paul|/' main.adx
	sed -i 's/{Bybee|/{Bybee, Joan L.@Bybee, Joan L.|/' main.adx
	sed -i 's/{Michaelis|/{Michaelis, Susanne Maria@Michaelis, Susanne Maria|/' main.adx
	sed -i 's/{Hawkins|/{Hawkins, John A.@Hawkins, John A.|/' main.adx
	sed -i 's/{Meillet|/{Meillet, Antoine@Meillet, Antoine|/' main.adx
	sed -i 's/{Grossman|/{Grossman, Eitan@Grossman, Eitan|/' main.adx
	sed -i 's/{de Saussure|/{de Saussure, Ferdinand@de Saussure, Ferdinand|/' main.adx
